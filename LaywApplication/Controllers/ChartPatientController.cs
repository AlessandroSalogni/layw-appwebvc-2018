...
namespace LaywApplication.Controllers
{
    ...
    public class StepsPatientController : ChartPatientController<int>
    {
        ...
        public async override Task<List<HistoryElement>> GetHistory(int id, string beginDate, string period)
        {
            ...
            JObject obj = await Utils.APIUtils.GetAsync(config.Value.GetTotalUrlUser() + id + "/" + SummaryConfig.Url + "?" + ParametersConfig.Date + "=27-06-2018&" + ParametersConfig.Period + "=" + period);//todo beginDate
